...
def setup_training_loop_kwargs(
    ...
    t_start_kimg  = None,    # The start of the transition    #Me
    t_end_kimg  = None,    # The end of the transition    #Me
    ...
    description= None,  # The suffix added to the description of the experiment.    #Me
):
    ...
    # Final description
    if description is not None:    #Me
        desc += f'-{description}'    #Me
...
@click.option('--description', help='The suffix for the name of the experiment', type=str, metavar='STRING')    #Me
